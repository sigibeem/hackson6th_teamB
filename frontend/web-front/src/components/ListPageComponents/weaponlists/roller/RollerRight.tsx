    ...
    <div>
      {roller.map((rollers) => {
        ...
        <ul className='listitemsUlRight' key={rollers.id}>
          <li data-weapon={rollers.weapon_name} data-range={rollers.range} data-firerate={rollers.fire_rate} data-damage={rollers.damage} data-display={rollers.display_name} className='listitemsLiRight' onClick={handleClick}>
