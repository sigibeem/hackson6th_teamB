    ...
    <div>
      {slosher.map((sloshers) => {
        ...
        <ul className='listitemsUlLeft' key={sloshers.id}>
          <li data-weapon={sloshers.weapon_name} data-range={sloshers.range} data-firerate={sloshers.fire_rate} data-damage={sloshers.damage} data-display={sloshers.display_name} className='listitemsLiLeft' onClick={handleClick}>
